...
#NOTE, for comparison against posix file per.
...
#----------------------------------------------------------------------
CONFIG=(
  ug-4096-64Mss-shared-col
  ug-4096-256Mss-shared-col
  ug-4096-shared-ind
  )
...
JID_DEP=`runConfigKraken/qsub-seq-48k.sh ./runConfigKraken ./IOBenchmarkUniformGrid $CB_ALIGN $JID_DEP "${CONFIG[@]}"`
if [[ -z "$JID_DEP" ]]
then
