...
function submit_sequence()
{
  ...
  #N_PROCS="48000 32760 24000 16380"
  #N_PROCS=24000
  #N_PROCS=1638
  ...
  do
    ...
    # asign variables passed into the batch script
...
BATCH_SCR=$CONFIG_HOME/io-benchmark.qsub
CLEANUP_SCR=$CONFIG_HOME/io-cleanup.qsub

for JOB_NAME in $*
do
  submit_sequence $JOB_NAME $BATCH_SCR $CLEANUP_SCR $EXE $CONFIG_HOME/$JOB_NAME.conf log/$JOB_NAME.log ./data/ $CB_ALIGN $CONFIG_HOME/null.qsub
done
